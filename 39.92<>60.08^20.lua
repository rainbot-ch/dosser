...
chance       = 39.92
bethigh      = false
basebet      = balance / 3992 --balance * (((balance / (99 / chance)) / chance) * 1)
nextbet      = basebet
...
profittotal=profittotal+currentprofit;  
curtime   = clock()
...
if chance == 39.92 then chance = 60.08 else chance = 39.92 end if (bethigh == true) then bethigh = false direction = " low" else bethigh = true direction = " high" end 
